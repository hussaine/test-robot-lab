    ...
    while True:
        ...
        if not people:
            ...
            cv2.putText(frame, f"person {confidence:.0%}",
                        (round(x1), max(25, round(y1) - 10)),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 0), 2)
            cv2.circle(frame, (person_center_x, person_center_y), 6,
                       (0, 0, 255), -1)
        ...
        cv2.putText(frame, f"PERSON: {region}", (20, 35),
        ...
        cv2.putText(frame, f"distance: {distance_text}", (20, 140),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
        cv2.putText(frame, f"DRIVE: {drive_state}", (20, 175),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
